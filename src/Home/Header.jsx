...
function Header() {
    return (
        <div className="w-full h-[600px] flex justify-center items-center bg-gray-50">
            <div className="flex flex-col gap-[5px]   md:flex-row md:justify-between md:items-center  sm:px-2 md:px-5  bg-gray-50 md:pt-[0px] md:h-[600px] md: w-[90%] md: border border-gray-200 md:p-[0px] md: gap-[100px]">  
